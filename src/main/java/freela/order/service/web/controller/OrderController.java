...
public class OrderController {
    ...
    @GetMapping
    public ResponseEntity<List<Order>> getAll(@RequestParam(required = true, name = "subCategoriesIds") List<Integer> subCategoriesIds, @RequestParam(required = false, name = "orderType") String orderType) {
